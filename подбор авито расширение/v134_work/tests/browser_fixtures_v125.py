    ...
    async with async_playwright() as pw:
        with tempfile.TemporaryDirectory(prefix='avito-fixture-chromium-') as profile:
            ...
            async def load(html):
                ...
                assert (await page.evaluate("AF_FIXTURE_SEND({type:'AF_AVITO_PING'})"))['version']=='1.0.34'
                return 1
