...
run('adapter_identity',[sys.executable,'tests/check_packaged_adapter_v136.py',str(ROOT),str(OUT/'adapter_identity.json')],timeout=45)
...
for n,f,key,t in [('dom_contracts','v129/browser_contracts.py','AF_V129_BROWSER_REPORT',30),('popup_lifecycle','v129/browser_popup_lifecycle.py','AF_POPUP_LIFECYCLE_REPORT',45),('actions_scopes','v129/browser_actions.py','AF_ACTION_REPORT',30),('proxy_transport_isolation','v131/browser_proxy_transport_isolation.py','AF_PROXY_ISOLATION_REPORT',60)]:
    run(n,[sys.executable,'tests/'+f],{key:OUT/(n+'.json')},t)
