...
test("manual endpoint creation remains explicit; automatic Avito recovery may create one sticky rotation=-1 endpoint only inside the existing package", () => {
  ...
  assert.match(worker, /rotation:\s*-1/);
