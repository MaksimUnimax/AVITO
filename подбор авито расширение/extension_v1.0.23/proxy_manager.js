/* Avito Finder v1.0.23 — Proxy.Market recovery is evidence-driven: keep the selected every-request profile, force a fresh proxy transport epoch, verify real egress rotation, and only then reload Avito. */
"use strict";
